...
import PuLP
import pid
def optymalize_mission(start_point: list = [0, 0]):
    ...
    #get path to travel
    a = pid.main(color_points=brown_points+gold_points, white_points=white_points, _start=np.array([start_point,"white", "false"]), distance=0.5)
    return a


optymalize_mission([50.06296, 19.91573])
